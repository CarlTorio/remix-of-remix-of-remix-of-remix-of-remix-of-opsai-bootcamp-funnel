...
export default function Section4WhatThisIs() {
  return (
    <section
      ...
      style={{ backgroundColor: "#06070e", marginTop: "-160px", zIndex: 10 }}
    >
      ...
      <div className="relative max-w-[780px] mx-auto text-center">
        ...
        <RevealBlock delay={120} className="max-w-2xl mx-auto mb-12">
          <div className="bg-[#ffb700]/5 border border-[#ffb700]/25 rounded-2xl px-6 py-8 shadow-[0_0_60px_rgba(255,183,0,0.08)]">
