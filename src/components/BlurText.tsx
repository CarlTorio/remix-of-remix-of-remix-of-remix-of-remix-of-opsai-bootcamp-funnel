...
const BlurText = ({
  ...
  // If children are provided, render them as-is with the reveal wrapper
  if (children) {
    return (
      <motion.div
  ...
  return (
    <p ref={ref as React.RefObject<HTMLParagraphElement>} className={className} style={{ display: 'flex', flexWrap: 'wrap' }}>
