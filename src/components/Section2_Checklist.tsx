...
const items = [
  { tag: "FOOD & BEVERAGE", biz: "You run a food & beverage business", rest: <>and you want to build your own <strong className="text-white uppercase">POS-Connected System</strong> with <strong className="text-white uppercase">Inventory</strong>, <strong className="text-white uppercase">Sales</strong>, <strong className="text-white uppercase">Orders</strong>, and <strong className="text-white uppercase">Reporting</strong> visibility</> },
  { tag: "E-COMMERCE", biz: "You run an e-commerce business", rest: <>and you want to connect your <strong className="text-white uppercase">Warehouse</strong>, <strong className="text-white uppercase">Orders</strong>, <strong className="text-white uppercase">Fulfillment</strong>, <strong className="text-white uppercase">Logistics</strong>, <strong className="text-white uppercase">Inventory</strong>, and <strong className="text-white uppercase">Accounting</strong> into one clear system</> },
  { tag: "SERVICE-BASED", biz: "You run a service-based business", rest: <>and you need a better way to manage <strong className="text-white uppercase">Projects</strong>, <strong className="text-white uppercase">Client Delivery</strong>, <strong className="text-white uppercase">Team Tasks</strong>, <strong className="text-white uppercase">Billing</strong>, and <strong className="text-white uppercase">Progress Monitoring</strong></> },
  { tag: "AGENCY / CONSULTANCY", biz: "You run an agency or consultancy", rest: <>and you want a system for <strong className="text-white uppercase">Lead Tracking</strong>, <strong className="text-white uppercase">Onboarding</strong>, <strong className="text-white uppercase">Approvals</strong>, <strong className="text-white uppercase">Delivery</strong>, <strong className="text-white uppercase">Reports</strong>, and <strong className="text-white uppercase">Renewals</strong></> },
  { tag: "CONSTRUCTION", biz: "You run a construction business", rest: <>and you need to monitor <strong className="text-white uppercase">Materials</strong>, <strong className="text-white uppercase">Manpower</strong>, <strong className="text-white uppercase">Project Progress</strong>, <strong className="text-white uppercase">Billing</strong>, <strong className="text-white uppercase">Approvals</strong>, and <strong className="text-white uppercase">Site Updates</strong> in one place</> },
  { tag: "RETAIL / DISTRIBUTION / FRANCHISE", biz: "You run a retail, distribution, or franchise business", rest: <>and you want visibility over <strong className="text-white uppercase">Stocks</strong>, <strong className="text-white uppercase">Collections</strong>, <strong className="text-white uppercase">Branch Performance</strong>, <strong className="text-white uppercase">Product Movement</strong>, and <strong className="text-white uppercase">Operations</strong></> },
  { tag: "FINANCE / HR / ADMIN", biz: "You run an accounting, finance, admin, or HR-heavy business", rest: <>and you want your own internal system for <strong className="text-white uppercase">Records</strong>, <strong className="text-white uppercase">Approvals</strong>, <strong className="text-white uppercase">Workflows</strong>, <strong className="text-white uppercase">Employee Access</strong>, and <strong className="text-white uppercase">Reporting</strong></> },
  { tag: "OR SIMPLY...", biz: "Or you're simply a business owner", rest: <>who wants to stop depending on <strong className="text-white uppercase">Spreadsheets</strong>, <strong className="text-white uppercase">Scattered Tools</strong>, and <strong className="text-white uppercase">Manual Monitoring</strong> just to understand what's happening in the business</>, catchAll: true },
];
