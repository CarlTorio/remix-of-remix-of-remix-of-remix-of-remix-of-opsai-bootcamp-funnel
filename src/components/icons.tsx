...
export const CheckCircle = ({ className = "" }: { className?: string }) => (
  <svg className={className} width="22" height="22" viewBox="0 0 22 22" fill="none">
    <circle cx="11" cy="11" r="11" fill="hsl(223 85% 70%)" />
...
export const CyanCheck = ({ className = "" }: { className?: string }) => (
  <svg className={className} width="18" height="18" viewBox="0 0 18 18" fill="none">
    <circle cx="9" cy="9" r="9" fill="hsl(223 85% 70% / 0.15)" />
    <path d="M5.5 9l2.5 2.5 4.5-4.5" stroke="hsl(223 85% 70%)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const CyanArrow = ({ className = "" }: { className?: string }) => (
  <svg className={className} width="18" height="18" viewBox="0 0 18 18" fill="none">
    <path d="M7 4l5 5-5 5" stroke="hsl(223 85% 70%)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const ShieldCheck = ({ className = "" }: { className?: string }) => (
  <svg className={className} width="48" height="48" viewBox="0 0 48 48" fill="none">
    <path d="M24 4L6 12v12c0 11 8 18 18 22 10-4 18-11 18-22V12L24 4z" fill="hsl(223 85% 70% / 0.15)" stroke="hsl(223 85% 70%)" strokeWidth="2" />
    <path d="M17 24l5 5 9-9" stroke="hsl(223 85% 70%)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

// Industry icons
export const FoodIcon = ({ className = "" }: { className?: string }) => (
  <svg className={className} width="28" height="28" viewBox="0 0 28 28" fill="none" stroke="hsl(223 85% 70%)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
