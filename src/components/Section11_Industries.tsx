    ...
    <section className="py-12 md:py-20 section-divider">
      <div ref={ref} className="container max-w-[1100px]">
        ...
        <p className="text-center font-body text-base text-muted-foreground">
          This is why the offer is so strong: you are not buying information — you are buying <span className="text-accent font-semibold" style={{ textShadow: "0 0 15px hsl(223 85% 70% / 0.3)" }}>operational leverage</span>.
        </p>
      </div>
    </section>
  );
