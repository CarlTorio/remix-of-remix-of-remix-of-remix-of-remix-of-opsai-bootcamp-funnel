...
const problems = [
  ...
  },
  {
    ...
    description: 'No dashboards. No reports.\nNo real-time data.\nYou make decisions based on gut.\nNot numbers.',
    bg: '#9B1111',
  },
  {
    num: '05',
...
const ProblemsSection = () => {
  return (
    <section style={{ background: '#1A0000', width: '100%', padding: '80px 0' }}>
      ...
      >
        {problems.map((p) => (
          <ScrollStackItem key={p.num} itemClassName="" >
            <div
              style={{
                background: p.bg,
                position: 'absolute',
