...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class ShaderPass {
      ...
      camera: THREE.Camera | null = null; material: any = null;
      geometry: any = null; plane: any = null;
    ...
    class ExternalForce extends ShaderPass {
      mouse: any;
      constructor(simProps: any) {
        super({ output: simProps.dst }); this.initForce(simProps);
      }
    ...
    class Simulation {
      ...
      advection: any; externalForce: any; viscous: any;
      divergence: any; poisson: any; pressure: any;
    ...
    class WebGLManager {
      props: any; output!: Output; running = false;
      autoDriver: AutoDriver; lastUserInteraction: number;
