  ...
  <section className="relative flex flex-col items-center overflow-hidden bg-background">
    ...
    <div className="relative z-10 container text-center -mt-16 md:-mt-24 pb-16 md:pb-24">
      ...
      <h1 className="font-heading font-extrabold text-[26px] md:text-[44px] leading-[1.1] mb-6 max-w-4xl mx-auto flex flex-wrap items-center justify-center gap-x-3">
        ...
        <FuzzyText fontSize="clamp(1.5rem, 3.5vw, 3rem)" fontWeight={800} color="#fbbd23" baseIntensity={0.2} hoverIntensity={0.5} enableHover fuzzRange={30} className="inline-block align-middle" fontFamily="inherit">A.I.</FuzzyText> <span>in Less Than</span> <ShinyText text="2 Weeks" speed={2} delay={0} color="#fbbd23" shineColor="#ffffff" spread={120} direction="left" className="" />
      </h1>
