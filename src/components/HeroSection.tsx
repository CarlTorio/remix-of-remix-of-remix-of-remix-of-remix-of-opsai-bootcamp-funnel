        ...
        <div className="h-screen w-full overflow-hidden relative">
          ...
          >
            ...
            <div className="relative w-full overflow-hidden">
              <img src={isMobile ? heroBgMobile : heroBgDesktop} alt="" className="w-full h-auto md:scale-100 scale-[1.35] origin-top md:translate-y-0 -translate-y-[13.5rem]" width={1920} height={1080} />
              <div className="absolute inset-0 bg-gradient-to-b from-background/60 via-transparent to-background" />
            </div>
            {/* Text content */}
            <div className="md:relative md:z-10 md:container md:text-center md:-mt-24 absolute bottom-4 left-0 right-0 z-10 container text-center" style={isMobile ? { textShadow: "0 2px 12px rgba(0,0,0,0.8), 0 0 30px rgba(0,0,0,0.6)" } : undefined}>
