...
const stackCards = [
  {
    ...
    gradient: "from-[#fff7d6] via-[#ffe88a] to-[#fcd34d]",
  ...
  },
  {
    ...
    gradient: "from-[#f9c832] via-[#e5a910] to-[#c48d0a]",
    image: cardReports,
  },
];
