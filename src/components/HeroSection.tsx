        ...
        <div className="h-screen w-full overflow-hidden relative">
          ...
          >
            ...
            <div className="relative w-full overflow-hidden">
              <img src={isMobile ? heroBgMobile : heroBgDesktop} alt="" className="w-full h-auto md:scale-100 scale-125 origin-top md:translate-y-0 -translate-y-20" width={1920} height={1080} />
