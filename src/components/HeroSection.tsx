  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: `url('https://prrjyforguhxcouhkzqs.supabase.co/storage/v1/object/public/Video%20-%20Image%20Hosting/Background%20-%20V9.png')` }}
      >
        ...
        <div className="relative z-10">
          ...
          <div className="relative w-full text-center py-12 md:py-20">
            ...
            <p className="relative z-10 text-foreground font-body text-xl md:text-2xl mb-3">
