        ...
        <div className="h-screen w-full overflow-hidden relative">
          ...
          >
            ...
            <div className="relative w-full overflow-hidden">
              <img src={isMobile ? heroBgMobile : heroBgDesktop} alt="" className="w-full h-auto md:scale-100 scale-125 origin-top md:translate-y-0 -translate-y-[8.75rem]" width={1920} height={1080} />
              <div className="absolute inset-0 bg-gradient-to-b from-background/60 via-transparent to-background" />
            </div>
            {/* Text content */}
            <div className="relative z-10 container text-center -mt-16 md:-mt-24 -translate-y-20 md:translate-y-0">
