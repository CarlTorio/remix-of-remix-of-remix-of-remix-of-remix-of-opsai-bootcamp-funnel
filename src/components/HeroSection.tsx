  ...
  <section className="relative flex flex-col items-center overflow-hidden bg-background">
    ...
    <div className="relative z-10 container text-center -mt-16 md:-mt-24 pb-16 md:pb-24">
      ...
      <h1 className="font-heading font-extrabold text-[26px] md:text-[44px] leading-[1.1] mb-6 max-w-4xl mx-auto">
        ...
        <FuzzyText fontSize="inherit" fontWeight={800} fontFamily="inherit" color="#fbbd23" baseIntensity={0.2} hoverIntensity={0.5} enableHover fuzzRange={30} className="inline-block align-middle -my-2">Artificial Intelligence</FuzzyText> in Less Than <ShinyText text="2 Weeks" speed={2} delay={0} color="#fbbd23" shineColor="#ffffff" spread={120} direction="left" className="" />
      </h1>
